...
slug: plural-rules
category: i18n
summary: "Most languages don't pluralise like English. Use CLDR plural categories — zero, one, two, few, many, other — via Intl.PluralRules instead of hard-coded 'item' vs 'items' logic."
status: recommended
order: 45
appliesTo: [all]
